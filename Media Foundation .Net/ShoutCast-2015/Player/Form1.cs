...
namespace MF_BasicPlayback
{
    public partial class Form1 : Form
    {
        ...
        private void UpdateMeta()
        {
            ...
            string [] sa = g_pPlayer.GetMetaNames();
            int newrows = sa.Length - dataGridView1.Rows.Count;
            ...
            {
                HResult hr = g_pPlayer.GetProperty(sa[x], pValue);
                dataGridView1.Rows[x].Cells[0].Value = sa[x];
                dataGridView1.Rows[x].Cells[1].Value = pValue.GetString();
            }
        }
    }
