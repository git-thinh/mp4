        ...
        public object GetBlob(Type t, int offset)
        {
            if (type == VariantType.Blob)
            {
                ...
                if (blobValue.cbSize > offset)
                {
                    ...
                    {
                        o = Marshal.PtrToStructure((IntPtr)((int)blobValue.pBlobData + offset), t);
                    }
                    else
                    {
    ...
    public class WaveFormatEx
    {
        ...
        public IntPtr GetPtr()
        {
            ...
            if (this is WaveFormatExtensibleWithData)
            {
                ...
                IntPtr ip2 = (IntPtr)((int)ip + iExtensibleSize);
            ...
            else if (this is WaveFormatExWithData)
            {
                ...
                IntPtr ip2 = (IntPtr)((int)ip + iWaveFormatExSize);
        ...
        public static WaveFormatEx PtrToWave(IntPtr pNativeData)
        {
            ...
            if (wFormatTag != -2)
            {
                ...
                else
                {
                    ...
                    IntPtr ip2 = (IntPtr)((int)pNativeData + 18);
            ...
            else
            {
                ...
                else
                {
                    ...
                    Marshal.Copy((IntPtr)((int)pNativeData + 24), byteGuid, 0, 16);
                    ext.SubFormat = new Guid(byteGuid);

                    ext.byteData = new byte[iExtraBytes];
                    IntPtr ip2 = (IntPtr)((int)pNativeData + Marshal.SizeOf(typeof(WaveFormatExtensible)));
    ...
    public class BitmapInfoHeader
    {
        ...
        public IntPtr GetPtr()
        {
            ...
            if (this is BitmapInfoHeaderWithData)
            {
                ...
                IntPtr ip2 = (IntPtr)((int)ip + iBitmapInfoHeaderSize);
        ...
        public static BitmapInfoHeader PtrToBMI(IntPtr pNativeData)
        {
            ...
            else
            {
                ...
                IntPtr ip2 = (IntPtr)((int)pNativeData + Marshal.SizeOf(typeof(BitmapInfoHeader)));
